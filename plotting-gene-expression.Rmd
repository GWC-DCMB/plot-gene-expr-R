...
<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//initial_rstudio.png?raw=true" width="700"/>
...
<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//history.png?raw=true" width="700"/>
...
<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//global_options.png?raw=true" width="600"/>
...
<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//general_options.png?raw=true" width="600"/>
...
<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//new_project_menu.png?raw=true" width="600"/>

When the smaller window opens, select "Existing Directory" and then the "Browse" button in the next window.

<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//existing_directory.png?raw=true" width="600"/>

<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//browse.png?raw=true" width="600"/>

Navigate to the directory that contains your code and data from the setup instructions and click the "Open" button.

<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//navigate_to_project.png?raw=true" width="600"/>

Then click the "Create Project" button.

<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//create_project.png?raw=true" width="600"/>
...
<img src="https://github.com/GWC-DCMB/plot-gene-expr-R/blob/main/1_introR/images//files_with_rproj.png?raw=true" width="600"/>
...
> ### Exercise: Make a boxplot plot for expression of the gene GATA4 at 6 weeks compared to 24 weeks.
> ```{r}
> # CHALLENGE:
...
dat_joined_long %>%
    ...
    labs(title = 'ACTN2', x = '# of weeks', y = 'log2 gene expression')
```
> ### Exercise: modify your boxplot for GATA4. Make each box a different color or fill (or both!)
>
